...
function SectionTitle({ title }) {
  return (
    <>
      <div className="flex items-center justify-center w-[700px] max-[800px]:w-full">
        <div className="h-[1px] mt-3 mr-5 flex-1 bg-gradient-to-r from-emerald-900 to bg-emerald-400"></div>
        <h1 className="text-emerald-400 text-3xl font-semibold text-center whitespace-nowrap">
          {title}
        </h1>
