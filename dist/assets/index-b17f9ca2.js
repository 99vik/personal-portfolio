...
const g3 = [
  ...
  "In addition to my studies, I've delved into the world of full-stack web development since June 2022 and have been in love with it ever since.",
...
const $S = './assets/javascript-48d02175.png',
  ...
  XS = './assets/css-32634011.png',
  qS = './assets/rails-0ff37859.png',
  e4 = './assets/react-f8b600a3.png',
  t4 = './assets/postgresql-98ceab8b.png',
  n4 = './assets/tailwind-d9abc2e8.png',
  r4 =
  ...
  i4 = './assets/github-60d03f0f.png',
  l4 = './assets/vite-33d4b497.png',
  o4 = './assets/webpack-e81d3131.png',
  a4 = './assets/vscode-fc6b4fb2.png',
  u4 = './assets/messageapp1-72f2647a.png',
  s4 = './assets/messageapp2-4fd210a6.png',
  c4 = './assets/messageapp3-3b75558d.png',
  f4 = './assets/messageapp4-b05adcd2.png',
  d4 = './assets/messageapp5-6d09dee3.png',
  p4 = './assets/messageapp6-db9168a6.png',
  h4 = './assets/waldo1-2d880d94.png',
  m4 = './assets/waldo2-dbc7a7fd.png',
  g4 = './assets/waldo3-98de4a65.png',
  v4 = './assets/shoppingapp1-fcde9c2e.png',
  y4 = './assets/shoppingapp2-2303267c.png',
  w4 = './assets/shoppingapp3-e9c67b7e.png',
  k4 = './assets/shoppingapp4-a847ae31.png',
  x4 = './assets/odinbook1-18a584c4.png',
  S4 = './assets/odinbook2-fd9b7e55.png',
  b4 = './assets/odinbook3-6686c683.png',
  E4 = './assets/todo1-f95ab912.png',
  C4 = './assets/todo2-085e5b59.png',
  P4 = './assets/todo3-da55e66f.png',
  T4 = './assets/weatherapp1-b2022984.png',
  A4 = './assets/weatherapp2-75fa1282.png',
  _4 = './assets/weatherapp3-0f957f3b.png',
  N4 = './assets/battleship1-084de9ea.png',
  O4 = './assets/battleship2-0925b45a.png',
  I4 = './assets/battleship3-8252145b.png',
  R4 = './assets/chess1-9958d7f3.png',
  M4 = './assets/chess2-9b471d03.png',
  j4 = [
    {
      name: 'Messaging App',
      images: [u4, s4, c4, f4, d4, p4],
...
function D4() {
  const e = j4.map((t, r) => ({ key: r, content: K.jsx(xw, { project: t }) }));
  return K.jsxs('div', {
    className:
    ...
    children: [
      K.jsx('div', {
        className:
          'h-[250px] w-[100px] max-[800px]:hidden animate-bgLight2 bg-emerald-500 rounded-full z-50 blur-3xl absolute -top-[10%] left-0',
      }),
...
const z4 = [
  ...
  },
  {
    ...
    data: [
      { name: 'Rails', icon: qS },
      { name: 'React', icon: e4 },
      { name: 'Tailwind', icon: n4 },
      { name: 'PostgreSQL', icon: t4 },
    ],
  },
  {
    title: 'Miscellaneous',
    data: [
      ...
      { name: 'Github', icon: i4 },
      { name: 'Vite', icon: l4 },
      { name: 'Webpack', icon: o4 },
      { name: 'VS Code', icon: a4 },
    ],
  },
];
function F4() {
...
_d.createRoot(document.getElementById('root')).render(
  K.jsx(tk.StrictMode, { children: K.jsx(L4, {}) })
);
